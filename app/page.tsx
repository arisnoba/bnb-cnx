      ...
      <section className="relative h-screen bg-brand-purple overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto h-full flex flex-col justify-end pb-20 px-20">
          ...
          <div className="flex items-center gap-2">
            <span className="text-brand-neon text-[97px] font-black uppercase leading-none">
              BNB CN
            </span>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-2 gap-20">
            ...
            <div className="flex flex-col justify-center">
              <h2 className="text-brand-neon text-[48px] font-black mb-8">
                Vision
              </h2>
              <p className="text-white text-[24px] font-semibold leading-[1.35]">
                브랜드의 실질적 성장을 돕는 글로벌 브랜딩 & 커머스 파트너 BNB
                CNX는 글로벌의 장벽이었던 콘텐츠, 유통, 트래픽, 마케팅의
                어려움을 넘어, 브랜드가 타겟팅한 시장 안에서 실질적인 성과를
                경험할 수 있도록 설계된 비즈니스를 만들어 나갑니다.
                <br />
                <br />
                전략 기획부터 실행까지 하나의 흐름으로 연결되며, 브랜드에게
                &apos;성과를 보이고, 상품이 팔리고, 매출이 상승하는&apos; 경험을
                만들어가는 것, 그것이 BNB CNX가 추구하는 비전입니다.
              </p>
            </div>
          </div>
        </div>
