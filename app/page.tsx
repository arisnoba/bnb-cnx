      ...
      <main className="min-h-screen home-page">
         <div className="space-y-4 md:space-y-10 cnx-wrapper">
            ...
            <section className="relative flex bg-brand-purple overflow-hidden md:aspect-[16/9] hero-section md:h-auto">
               ...
               <button
                  onClick={toggleMute}
                  className="absolute bottom-6 right-6 sm:bottom-auto sm:right-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 z-40 p-3 sm:p-5 rounded-full border sm:border-2 border-white text-white transition-all duration-300 hover:md:scale-110 hover:md:border-[#baff00] hover:md:text-[#baff00] opacity-70"
               >
                  {isMuted ? (
                     <svg className="w-5 md:w-8 h-5 md:h-8" width="40" height="40" viewBox="0 0 24 24" fill="currentColor">
