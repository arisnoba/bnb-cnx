          ...
          <div className="container mx-auto">
            <div className="flex items-center justify-center gap-2 text-[52px] font-black">
              ...
              <div className="bg-brand-purple px-3 flex items-center gap-1">
                <span className="text-brand-neon text-[59.746px] font-black uppercase leading-none">
                  BNB CN
                </span>
                <div className="w-[42px] h-[42px] relative">
                  ...
                  >
                    <circle cx="21" cy="21" r="20" fill="#baff00" />
                  </svg>
                </div>
              </div>
        ...
        <div className="flex-1 flex items-center overflow-hidden">
          ...
          >
            {services.map((service) => (
              <div
                key={service.id}
                className={`flex-shrink-0 w-[640px] h-[640px] rounded-[40px] ${service.bgColor} overflow-hidden relative group cursor-pointer`}
              >
                {/* Background Image */}
                ...
                <div className="relative z-10 h-full flex flex-col justify-between p-12 bg-gradient-to-b from-black/30 to-transparent">
                  <div className="flex justify-between items-start">
                    <div className="text-white">
                      <h3 className="text-[32px] font-black mb-3">
                        {service.title}
                      </h3>
