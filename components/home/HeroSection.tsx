...
export default function HeroSection() {
	...
	return (
		<section className="relative flex bg-brand-purple overflow-hidden md:aspect-[16/9] hero-section md:h-auto">
			...
			<button
				onClick={toggleMute}
				className="absolute bottom-6 right-6 md:right-[clamp(24px,-1.4545454545px+4.2424242424vw,80px)] md:bottom-[clamp(24px,-1.4545454545px+4.2424242424vw+80px,160px)] z-40 p-3 sm:p-3 lg:p-4 rounded-full border sm:border-2 border-white text-white transition-all duration-300 hover:md:scale-110 hover:md:border-[#baff00] hover:md:text-[#baff00] opacity-70">
				{isMuted ? (
					<svg className="w-5 h-5 lg:w-5 lg:h-5" width="40" height="40" viewBox="0 0 24 24" fill="currentColor">
