...
export default function ContactForm() {
  ...
  const handleCheckboxChange = (value: string, checked: boolean | 'indeterminate') => {
    ...
    setFormData(prev => ({
      ...prev,
      inquiry_types: checked
        ? [...prev.inquiry_types, value]
        : prev.inquiry_types.filter(type => type !== value)
    }))
  }
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-[40px]">
            ...
            {INQUIRY_TYPES.map((type) => (
              <div key={type} className="flex items-center gap-[4px]">
                <Checkbox
                  ...
                  onCheckedChange={(checked: boolean | 'indeterminate') => handleCheckboxChange(type, checked)}
                />
                <label
                  htmlFor={type}
                  className="text-[20px] font-medium text-[#666666] cursor-pointer"
                >
                  {type}
                </label>
              </div>
        ...
        <div className="flex flex-col gap-[20px] border-b border-[rgba(0,0,0,0.1)] pb-[40px]">
          ...
          <div className="grid grid-cols-2 gap-[20px]">
            <div className="flex flex-col gap-[4px]">
              ...
              <Select
                value={formData.brand_launch_status}
                onValueChange={(value: string) => handleSelectChange('brand_launch_status', value)}
              >
                <SelectTrigger>
            ...
            <div className="flex flex-col gap-[4px]">
              ...
              <Select
                value={formData.brand_launch_month}
                onValueChange={(value: string) => handleSelectChange('brand_launch_month', value)}
              >
                <SelectTrigger>
        ...
        <div className="flex items-center justify-center">
          <Button
            ...
            className="bg-[#222222] text-[#baff00] text-[28px] font-extrabold px-[40px] py-[20px] rounded-[100px] h-auto uppercase hover:bg-[#333333]"
          >
